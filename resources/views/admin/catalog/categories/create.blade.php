...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form method="post" action="/admin/catalog/categories/save" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="name" id="example-text-input" placeholder="Kategori Adı">
                            </div>
                        </div>
                    </div>
