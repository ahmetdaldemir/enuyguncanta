...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <form method="post" action="/admin/catalog/color/save" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Renk Ekle</h4>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Renk Adı</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="name" id="example-text-input" placeholder="Renk Adı">
                            </div>
                        </div>
                    </div>
