            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="admin/calendar/calendar" class=" waves-effect">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="admin/email/email-inbox">Inbox</a></li>
                                <li><a href="admin/email/email-read">Email Read</a></li>
                                <li><a href="admin/email/email-compose">Email Compose</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="admin/ui/ui-alerts">Alerts</a></li>
                                    <li><a href="admin/ui/ui-buttons">Buttons</a></li>
                                    <li><a href="admin/ui/ui-badge">Badge</a></li>
                                    <li><a href="admin/ui/ui-cards">Cards</a></li>
                                    <li><a href="admin/ui/ui-carousel">Carousel</a></li>
